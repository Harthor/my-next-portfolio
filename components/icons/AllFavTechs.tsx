  ...
  return (
    <>
      ...
      >
        ...
        <motion.li style={{ opacity: 1, transform: 'none' }} variants={animation}>
  <div title="Python" className='transition duration-200 hover:text-[#FFFFFF] filter grayscale hover:grayscale-0' style={{ transition: 'color 0.2s ease, filter 0.2s ease' }}>
    <PythonIcon style={{ width: '24px', height: '24px' }}/>
  </div>
</motion.li>
...
<motion.li style={{ opacity: 1, transform: 'none' }} variants={animation}>
  <div title="Django" className='transition duration-200 hover:text-[#f06292] filter grayscale hover:grayscale-0' style={{ transition: 'color 0.2s ease, filter 0.2s ease' }}>
    <DjangoIcon style={{ width: '24px', height: '24px' }}/>
  </div>
</motion.li>
